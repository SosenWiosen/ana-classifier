...
from model_tester.model.hypertune_model import hypertune_model
...
def run_hypertuning_and_export(save_path="", dst_path="", model_name="", data_augmentation="", tuner_working_dir='',
                               tuner_project_name='',
                               max_epochs=20, early_stopping=None, metrics=None, finetune=False,
    ...
    model, class_names, history, train_times, original_tuple, test_original_tuple, hypertune_summary, finetune_history, finetune_times, finetune_tuple, test_finetune_tuple, unfreeze_hypertune_summary = hypertune_model(
        train_path, test_path, model_name, data_augmentation, tuner_working_dir, tuner_project_name,
        early_stopping, metrics,
        finetune,
        finetune_early_stopping, save_directory, max_epochs=max_epochs,
